                        ...
                        <div class="sidebarBody_card" style="height:100%">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless text-right" style="margin: 0">
                                    <thead>
                                        <tr>
                                            <th style="padding: 0; width:35%; text-align: left">Trung bình NV</th>
                                            <th style="padding: 0; width:35%; text-align: left">TB theo tháng</th>
                                            <th style="padding: 0; width:30%; text-align: left">TB theo năm</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>                                        
                                            <td style="font-weight: 700; padding: 0; text-align: left">
                                                <span class="sidebarBody_card-body-subtitle">
                                                    <span class="sidebarBody_card-body-subtitle-before">Tháng: 15M</span>
