                        ...
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fw-bolder background_pink" data-bs-toggle="tooltip" data-bs-placement="top" title="Nhiệm vụ" scope="col" style="width: 15%">NV</th>
                                    <th class="fw-bolder background_green2" data-bs-toggle="tooltip" data-bs-placement="top" title="Nhiệm vụ TBP chấm" scope="col" style="width: 15%">NVC</th>
                                    <th class="fw-bolder background_yellow" data-bs-toggle="tooltip" data-bs-placement="top" title="KPI được giao" scope="col" style="width: 15%">ĐG</th>
                                    <th class="fw-bolder background_blue" data-bs-toggle="tooltip" data-bs-placement="top" title="KPI báo cáo" scope="col" style="width: 15%">BC</th>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="KPI TBP chấm" scope="col" style="width: 15%">KPIC</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="background_pink text-center">9</td>
                                    <td class="background_green2 text-center">2</td>
                                    <td class="background_yellow text-center">110</td>
                                    <td class="background_blue text-center">50</td>
                                    <td class="background_white text-center"><strong>45</strong></td>
                                </tr> 
                                <tr>
                                    <td class="background_white text-center">
                                        <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" title="Nhân viên">
                                            Nhân viên
                                        </div>
                                    </td>
                                    <td class="background_pink text-center">46</td>
                                    <td class="background_green2 text-center">12</td>
                                    <td class="background_yellow text-center">980</td>
                                    <td class="background_blue text-center">800</td>
                                    <td class="background_white text-center"><strong>750</strong></td>
                                </tr>                                  
                            </tbody>
                        </table>
                    </div>
                        ...
                        <div class="sidebarBody_card-items-pdf">
                            <div class="sidebarBody_card-items-wrapper mb-2 mt-2 d-flex align-items-start justify-content-between">
                                <div class="sidebarBody_card-items-left">
                                    <div class="sidebarBody_notification-title overText">
                                        <span
                                            >Vẽ màn chỉ số phân tích cho NV KD</span>
                                    </div>
                                    <div class="sidebarBody_notification-status">
                                        <div class="sidebarBody_card-text">
                            ...
                            <div class="sidebarBody_card-items-wrapper mb-2 d-flex align-items-start justify-content-between">
                                <div class="sidebarBody_card-items-left">
                                    <div class="sidebarBody_notification-title overText">
                                        <span
                                            >Vẽ màn chỉ số phân tích cho TBP KD</span>
                                    </div>
                                    <div class="sidebarBody_notification-status">
                                        <div class="sidebarBody_card-text">
                                            Người gửi: Nguyễn Văn A
