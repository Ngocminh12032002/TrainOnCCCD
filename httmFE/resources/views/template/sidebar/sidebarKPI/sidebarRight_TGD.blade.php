                        ...
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fw-bolder background_pink" data-bs-toggle="tooltip" data-bs-placement="top" title="Đạt KPI" scope="col" style="width: 18%">Đạt</th>
                                    <th class="fw-bolder background_green2" data-bs-toggle="tooltip" data-bs-placement="top" title="Chưa đạt KPI" scope="col" style="width: 18%">CĐ</th>
                                    <th class="fw-bolder background_yellow" data-bs-toggle="tooltip" data-bs-placement="top" title="Vượt KPI" scope="col" style="width: 18%">Vượt</th>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="Hoàn thành công việc" scope="col" style="width: 18%">HTCV</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="background_white text-center"><strong>36/42</strong></td>
                                </tr>                                 
                            </tbody>
                        </table>
                    </div>
