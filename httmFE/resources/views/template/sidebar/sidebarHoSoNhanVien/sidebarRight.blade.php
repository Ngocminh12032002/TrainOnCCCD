                ...
                <div class="sidebarBody_card bg-yellow-blur" style="margin-bottom: 16px;">
                    ...
                    <div class="sidebarBody_cardmini mt-3">
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="Vị trí" scope="col" style="width: 25%">VT</th>
                                    <th class="fw-bolder background_green2" data-bs-toggle="tooltip" data-bs-placement="top" title="Thâm niên" scope="col" style="width: 25%">TN</th>
                                    <th class="fw-bolder background_pink" data-bs-toggle="tooltip" data-bs-placement="top" title="Kỹ năng" scope="col" style="width: 25%">KN</th>
                                    <th class="fw-bolder background_yellow" data-bs-toggle="tooltip" data-bs-placement="top" title="Chứng chỉ" scope="col" style="width: 25%">CC</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                ...
                <div class="sidebarBody_card bg-pink-blur" style="margin-bottom: 16px;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mainSection_chart-container2 mt-3" id="Lương thưởng">
                                <canvas id="HSNV_LuongThuong"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sidebarBody_card bg-pink-blur" style="margin-bottom: 16px;">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="mainSection_chart-container2 mt-3" id="Hiệu suất làm việc">
                                <canvas id="HSNV_HieuSuatLamViec"></canvas>
                            </div>
                        </div>
                    </div>
                </div>              
                        ...
                        <div class="sidebarBody_card-items-pdf">
                            <div class="sidebarBody_card-items-wrapper mb-2 mt-2 d-flex align-items-start justify-content-between">
                                <div class="sidebarBody_card-items-left">
                                    <div class="sidebarBody_notification-title overText">
                                        <span
                                            >Nhận cấp phát từ kho <a href="#">XXX</a></span>
                                    </div>
                            ...
                            <div class="sidebarBody_card-items-wrapper mb-2 d-flex align-items-start justify-content-between">
                                <div class="sidebarBody_card-items-left">
                                    <div class="sidebarBody_notification-title overText">
                                        <span
                                            >Khen Thưởng NV Nguyễn Văn A</span>
                                    </div>
                                    <div class="sidebarBody_notification-status">
                                        <div class="sidebarBody_card-text">
