                        ...
                        <div class="col-md-12">
                            <div class="text-center">
                                <div class="sidebarBody_heading mt-2 mb-2 text-black">
                                    Chi phí nhập kho theo vùng
                                </div>
                            </div>
                            <div class="mainSection_chart-container2 mt-3" id="Chi phí nhập kho theo vùng">
                                <canvas id="NhapKho_ChiPhiTheoVung"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="sidebarBody_card bg-blue-blur" style="margin-bottom: 16px;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                <div class="sidebarBody_heading mt-2 mb-2 text-black">
                                    Chi phí nhập kho theo tháng
                                </div>
                            </div>
                            <div class="mainSection_chart-container2 mt-3" id="Chi phí nhập kho theo tháng">
                                <canvas id="NhapKho_ChiPhiTheoThang"></canvas>
                            </div>
                        </div>
                    </div>
                </div>              
