                        ...
                        <div class="sidebarBody_cardmini mt-3">
                            <table class="settable table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="background_white text-center">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" title="Đăng ký ăn">
                                                ĐK ăn
                                            </div>
                                        </td>
                                        ...
                                        <td class="background_blue text-center">0</td>
                                        <td class="background_white text-center">1</td>
                                    </tr> 
                                    <tr>
                                        <td class="background_white text-center">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" title="Có mặt">
                                                Có mặt
                                            </div>
                                        </td>
                                        <td class="background_green2 text-center">1</td>
                                        <td class="background_pink text-center">1</td>
                                        <td class="background_yellow text-center">0</td>
                                        <td class="background_blue text-center">0</td>
                                        <td class="background_white text-center">1</td>
                                    </tr>                                                                         
                                </tbody>
