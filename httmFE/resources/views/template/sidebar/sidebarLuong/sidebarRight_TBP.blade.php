            ...
            <div class="container">
                ...
                <div class="sidebarBody_wrapper mt-4 col-6 col-md-12">
                    ...
                    <table class="table" style="margin-right:5px">
                        <thead>
                            <tr>
                                <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Cán bộ nhân viên"
                                 scope="col" style="width: 34%">CBNV</th>
                                <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Lương cứng"
                                 scope="col" style="width: 15%">LC</th>
                                <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="KPI"
                                 scope="col" style="width: 15%">KPI</th>
                                <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Hoàn thành"
                                 scope="col" style="width: 15%">HT</th>
                                <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Tổng"
                                 scope="col" style="width: 21%">Tổng</th>
                            </tr>
                        </thead>
                    </table>
                                ...
                                <tbody style="max-height: 50px; overflow-y: scroll;">
                                    <tr>
                                        ...
                                        <td class="text-end" style="width: 15%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="5.000.000">
                                                5M
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="8.000.000">
                                                8M
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 18%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="100%">
                                                100%
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="13.000.000">
                                                13M
                                            </div>
                                        </td>
                                    </tr>  
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn B">
                                                Nguyễn Văn B
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn C">
                                                Nguyễn Văn C
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn D">
                                                Nguyễn Văn D
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn E">
                                                Nguyễn Văn E
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn F">
                                                Nguyễn Văn F
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn G">
                                                Nguyễn Văn G
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn H">
                                                Nguyễn Văn H
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                                    ...
                                    <tr>
                                        {{-- <th scope="row">1</th> --}}
                                        <td class="text-end" style="width: 37%">
                                            <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" style="text-align: left;" title="Nguyễn Văn I">
                                                Nguyễn Văn I
                                            </div>
                                        </td>
                                        <td class="text-end" style="width: 15%">
                    ...
                    <table>
                        <tr>
                            <th class="fw-bolder" scope="col" style="width: 42%"></th>
                            <th class="fw-bolder" scope="col" style="width: 16%"></th>
                            <th class="fw-bolder" scope="col" style="width: 16%"></th>
                            <th class="fw-bolder" scope="col" style="width: 16%">Tổng</th>
                            <th class="fw-bolder" scope="col" style="width: 16%">117M</th>
                        </tr>         
                    </table>
                </div> 
