                ...
                <div class="sidebarBody_card background_gray2">
                    ...
                    <div class="sidebarBody_cardmini mt-3">
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="" scope="col" style="width: 31%"></th>
                                    <th class="fw-bolder background_green2" data-bs-toggle="tooltip" data-bs-placement="top" title="Phản ánh" scope="col" style="width: 23%">PA</th>
                                    <th class="fw-bolder background_yellow" data-bs-toggle="tooltip" data-bs-placement="top" title="Đã phản hồi" scope="col" style="width: 23%">ĐPH</th>
                                    <th class="fw-bolder background_pink" data-bs-toggle="tooltip" data-bs-placement="top" title="Chưa phản hồi" scope="col" style="width: 23%">CPH</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="background_pink text-center"><strong>4</strong></td>
                                </tr>                             
                            </tbody>
                        </table>
                    </div>
