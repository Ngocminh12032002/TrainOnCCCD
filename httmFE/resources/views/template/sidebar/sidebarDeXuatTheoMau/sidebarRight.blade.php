                            ...
                            <table class="settable table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="background_white text-center">{{ $YCMS_TC + $YCMS_DD + $YCMS_DG }}</td>
                                    </tr>
                                    <tr>
                                        <td class="background_white text-center">
                                        ...
                                        <td class="background_white text-center">{{ $DNTT_TC + $DNTT_DD + $DNTT_DG }}</td>
                                    </tr>
                                    <tr>
                                        <td class="background_white text-center">
                                        ...
                                        <td class="background_white text-center">{{ $DNTU_TC + $DNTU_DD + $DNTU_DG }}</td>
                                    </tr>
