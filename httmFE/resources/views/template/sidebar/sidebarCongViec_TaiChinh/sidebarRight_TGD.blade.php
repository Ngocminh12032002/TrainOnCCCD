                            ...
                            <div class="sidebarBody_cardmini-wrapper" style="line-height: 2">
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        ...
                                        Hoàn thiện hồ sơ tiêu huỷ hàng
                                    </span>
                                    <strong>2</strong>
                                </div>                              
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm kê kho và lập báo cáo kho hàng
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Lập báo cáo tổng hợp N-X-T theo lô
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm soát khớp số liệu tồn kho giữa các kho
                                    </span>
                                    <strong>2</strong>
                                </div> 
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm tra hợp đồng của KH phát sinh
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm tra quyền lợi chi trả cho KH
                                    </span>
                                    <strong>2</strong>
                                </div>                                                   
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Số lần xử lý công việc chuyển phát
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm tra và tổng hợp báo cáo tích hợp
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                ...
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Báo cáo dòng tiền và lập dự chi hàng
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Kiểm tra việc ghi nhận các nghiệp vụ
                                    </span>
                                    <strong>2</strong>
                                </div>
                                <div class="sidebarBody_cardmini">
                                ...
                                <div class="sidebarBody_cardmini">
                                    <span class="sidebarBody_card-title">
                                        <i class="bi bi-file-earmark-text"></i>
                                        Tập hợp, hoàn thiện và ghi sổ các nghiệp vụ kế toán hợp lệ
                                    </span>
                                    <strong>2</strong>
                                </div>                                
                            </div>
                        ...
                        <div class="sidebarBody_card" style="height:100%">
                            <div class="sidebarBody_heading-wrapper">
                                <h6 class="sidebarBody_heading mt-1">                                
                                    ...
                                    Chi phí                         
                                    <span class="sidebarBody_heading-mini text-black">(Chi/Hạch toán)</span>
                                </h6>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless text-right" style="margin: 0">
                                    <thead>
                                        <tr>
                                            <th style="padding: 0; width:30%; text-align: left">NVL</th>
                                            <th style="padding: 0; width:30%; text-align: left">Vận chuyển</th>
                                            <th style="padding: 0; width:40%; text-align: left">Nghiên cứu & PT</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>                                        
                                            ...
                                            <td style="font-weight: 700; padding: 0; text-align: left">
                                                <span class="sidebarBody_card-body-subtitle">
                                                    <span class="sidebarBody_card-body-subtitle-before">27M</span>
                                                   <span class="sidebarBody_card-body-subtitle-separate"></span>
                                                    <span class="sidebarBody_card-body-subtitle-after"></span>
                                                </span>
                                            </td>
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="padding: 0; width:30%; text-align: left">Văn phòng</th>
                                            <th style="padding: 0; width:30%; text-align: left">Tài chính</th>
                                            <th style="padding: 0; width:40%; text-align: left">Thuế</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>                                        
