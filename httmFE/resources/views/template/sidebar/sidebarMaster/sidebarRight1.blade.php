                        ...
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="fw-bolder background_pink" data-bs-toggle="tooltip" data-bs-placement="top" title="Đạt KPI" scope="col" style="width: 18%">Đạt KPI</th>
                                    <th class="fw-bolder background_green2" data-bs-toggle="tooltip" data-bs-placement="top" title="Chưa đạt" scope="col" style="width: 18%">Chưa đạt</th>
                                    <th class="fw-bolder background_yellow" data-bs-toggle="tooltip" data-bs-placement="top" title="Vượt KPI" scope="col" style="width: 18%">Vượt KPI</th>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="HT công việc" scope="col" style="width: 18%">HT công việc</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="background_yellow text-center">3</td>
                                    <td class="background_white text-center"><strong>3/12</strong></td>
                                </tr>                                 
                            </tbody>
                        </table>
                    </div>
