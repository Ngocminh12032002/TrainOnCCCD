<div id="aside-right" class="aside-right">
    <div class="sidebar">
                        ...
                        <div class="sidebarBody_card" style="height:100%">
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless text-right" style="margin: 0">
                                    <thead>
                                        <tr>
                                            <th style="padding: 0; width:35%; text-align: left">Tháng</th>
                                            <th style="padding: 0; width:35%; text-align: left">Cả năm</th>
                                            <th style="padding: 0; width:30%; text-align: left">Quyết toán</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>                                        
        ...
        </span>d="btn-right"><i class="bi bi-arrow-bar-right"></i>
        </span>
    </div>
</div>
