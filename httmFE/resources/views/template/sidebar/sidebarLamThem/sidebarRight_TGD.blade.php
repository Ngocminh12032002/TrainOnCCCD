                ...
                <div class="sidebarBody_card background_gray2">
                    ...
                    <div class="sidebarBody_cardmini mt-3">
                        <table class="settable table table-bordered">
                            <thead>
                                <tr>
                                    <th class="fw-bolder background_white" data-bs-toggle="tooltip" data-bs-placement="top" title="Tháng 8" scope="col" style="width: 28%">Tháng 8</th>
                            ...
                            <tbody>
                                <tr>
                                    <td class="background_white text-center">
                                        <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top" title="Cán bộ nhân viên">
                                            CBNV
                                        </div>
                                    </td>
                                    <td class="background_green2 text-center">10</td>
                                    <td class="background_pink text-center">3</td>
                                    <td class="background_yellow text-center">4</td>
                            ...
                            <table class="table table-bordered"> 
                                <thead>
                                    <tr>
                                        ...
                                        <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Nhân viên Overtime"
                                         scope="col" style="width:16%">NVOT</th>
                                        <th class="fw-bolder" data-bs-toggle="tooltip" data-bs-placement="top" title="Thời gian Overtime"
                                         scope="col" style="width:16%">TGOT</th>
