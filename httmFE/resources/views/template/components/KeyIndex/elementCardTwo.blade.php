<div class="sidebarBody_card" style="height:100%">
    ...
    <div class="table-responsive">
        <table class="table table-borderless text-right" style="margin: 0">
            <thead>
                <tr>
                    <th style="padding: 0; width:35%; text-align: left">{{ isset($title_today) ? $title_today : '' }}</th>
                    <th style="padding: 0; width:35%; text-align: left">{{ isset($title_week) ? $title_week : '' }}</th>
                    <th style="padding: 0; width:30%; text-align: left">{{ isset($title_month) ? $title_month : '' }}</th>
                </tr>
            </thead>
            <tbody>
                <tr>
