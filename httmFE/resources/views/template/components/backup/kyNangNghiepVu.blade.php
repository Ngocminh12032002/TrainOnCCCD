                        ...
                        <div class="col-lg-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class='row'>
                                                        ...
                                                        <tr data-repeater-item>
                                                            ...
                                                            <td>
                                                                <div class="overText" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" data-bs-original-title=""> Kỹ
                                                                    năng mềm</div>
                                                            </td>
                                                            <td>
                                                                <div class="overText" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" data-bs-original-title="">
                                                                    ...
                                                                    năng sống, giao tiếp, lãnh đạo, làm việc theo nhóm, kỹ
                                                                    năng quản lý thời gian, thư giãn, vượt qua khủng hoảng,
                                                                    sáng tạo và đổi mới
                                                                </div>
                                                            </td>
                                                            <td>
                                            ...
                                            <tr data-repeater-item>
                                                ...
                                                <td>
                                                    <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-original-title=""> Kỹ năng mềm</div>
                                                </td>
                                                <td>
                                                    <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-original-title="">
                                                        Kỹ năng mềm hay còn gọi là Kỹ năng thực hành xã hội là thuật ngữ
                                                        liên quan đến trí tuệ xúc cảm dùng để chỉ các kỹ năng quan trọng
                                                        trong cuộc sống con người như: kỹ năng sống, giao tiếp, lãnh đạo,
                                                        làm việc theo nhóm, kỹ năng quản lý thời gian, thư giãn, vượt qua
                                        ...
                                        <tr data-repeater-item>
                                            ...
                                            <td>
                                                <div class="overText" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    data-bs-original-title="">
                                                    Kỹ năng mềm hay còn gọi là Kỹ năng thực hành xã hội là thuật ngữ liên
                                                    quan đến trí tuệ xúc cảm dùng để chỉ các kỹ năng quan trọng trong cuộc
                                                    sống con người như: kỹ năng sống, giao tiếp, lãnh đạo, làm việc theo
                                                    nhóm, kỹ năng quản lý thời gian, thư giãn, vượt qua khủng hoảng, sáng
                                                    tạo và đổi mới
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dotdotdot" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                                    aria-expanded="false"><i class="bi bi-three-dots-vertical"></i></div>
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li>
                                                        <a class="dropdown-item" href="#" data-bs-toggle="modal"
                                                            data-bs-target="#suaMoiDinhMuc">
                                    ...
                                    <!-- Modal Sửa Định Mức -->
                                    <div class="modal fade" id="suaMoiDinhMuc" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header text-center">
                                                    <h5 class="modal-title w-100" id="exampleModalLabel">Sửa kỹ năng
                                                        nghiệp vụ
                                                    </h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="text" name="name"
                                                                    ...
                                                                    title="Tên định mức" placeholder="Nhập tên định mức">
                                                            </div>
                                                            <div class="col-sm-12 mt-3">
                                                                <div class="mb-3">
                                                                    <textarea class="form-control" name="description" data-bs-toggle="tooltip" data-bs-placement="top"
                                                                        title="Mô tả thực hiện" placeholder="Nhập mô tả thực hiện"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="mb-3" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Đơn vị phụ trách">

                                                                    <select class="selectpicker" data-dropup-auto="false"
                                                                        name="departement_id" title="Đơn vị phụ trách"
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="mb-3" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Vị trí phụ trách">
                                                                    <select class="selectpicker" data-dropup-auto="false"
                                                                        name="position_id" title="Vị trí phụ trách"
                                                            ...
                                                            <div class="col-sm-3">
                                                                <div class="mb-3" data-bs-toggle="tooltip"
                                                                    data-bs-placement="top" title="Giờ">
                                                                    <input class="form-control" type="number"
                                                                        name="manday" min="0" step="0.05"
                                                                        placeholder="Nhập giờ công">
                                                                </div>
                                                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title text-danger" id="exampleModalLabel">Xóa kỹ năng
                                                        nghiệp vụ</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="mb-3">
                                    <select class="selectpicker" data-dropup-auto="false" required
                                        title="Thuộc nhóm việc" name="" data-width="100%" data-live-search="true"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <select class="selectpicker" data-dropup-auto="false" required
                                        title="Phòng ban phụ trách *" name="departement_id" data-width="100%"
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <select class="selectpicker" data-dropup-auto="false" required
                                        title="Vị trí phụ trách *" name="position_id" data-width="100%"
                                        data-live-search="true" data-live-search-placeholder="Tìm kiếm..."
                                        data-size="5">
                                        <option>1</option>
                                        <option>1</option>
                            ...
                            <div class="col-sm-4">
                                <div class="mb-3">
                                    <input class="form-control" required type="number" min="0" step="0.05"
                                        oninput="onInput(this)" placeholder="Thời lượng giờ công *" name="manday">
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <div class="mb-3">
                                    <select class="selectpicker" data-dropup-auto="false" title="Chọn chỉ số key"
                                        data-live-search="true" data-size="5" name="">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <select id="onChangeDonVi" class="selectpicker" data-dropup-auto="false"
                                        title="Chọn đơn vị tính" name="unit_id" data-live-search="true" data-size="5">
                ...
                <form method="POST" action="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal"
                            data-bs-toggle="modal" data-bs-target="#themMoiDinhMuc">Hủy</button>
                        <button type="submit" class="btn btn-danger">Lưu</button>
                    </div>
                </form>
            </div>
